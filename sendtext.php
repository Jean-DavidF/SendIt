...
?>
    <body>
        ...
        <ul id="progressbar">
            <li class="active">Rédaction du message</li>
            ...
            <div class="container 1" id="container-1">
                ...
                <div class="content" id="content-1">
                    <form id="form-sendtext" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" placeholder="Exemple : Audemard" name="lastname">
                        <br />
                        <label for="firstname">Indiquez votre Prénom</label>
                        <input type="text" placeholder="Exemple : Gilles" name="firstname">
                        <br />
                        <label for="subject">Indiquez votre Sujet</label>
                        <input type="text" placeholder="Information importante" name="subject">
                        <br />
                        <textarea name="message" id="message" rows="6" placeholder="Votre message..."></textarea>
                        <input id="submit-sendtext" class="submit mark-button mark-button-submit" type="submit" value="Valider" name="submit-sendtext">
